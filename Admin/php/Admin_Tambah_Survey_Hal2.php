...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query1 = "INSERT INTO survey (id_wilayah) VALUES ('$id_wilayah')";
    $query2 = "INSERT INTO gender (id_wilayah, laki_laki_sangat_puas, laki_laki_puas, laki_laki_kurang_puas, perempuan_sangat_puas, perempuan_puas, perempuan_kurang_puas, total_responden) 
               VALUES ('$id_wilayah', '$gender_sangat_puas_laki', '$gender_puas_laki', '$gender_kurang_puas_laki', '$gender_sangat_puas_perempuan', '$gender_puas_perempuan', '$gender_kurang_puas_perempuan', '$total_responden_gender')";

    $query3 = "INSERT INTO usia (id_wilayah, 18_35_sangat_puas, 18_35_puas, 18_35_kurang_puas, 36_up_sangat_puas, 36_up_puas, 36_up_kurang_puas, total_responden)
               VALUES ('$id_wilayah', '$usia_sangat_puas_18_35', '$usia_puas_18_35', '$usia_kurang_puas_18_35', '$usia_sangat_puas_36_plus', '$usia_puas_36_plus', '$usia_kurang_puas_36_plus', '$total_responden_usia')";

    $query4 = "INSERT INTO lulusan (id_wilayah, sd_sangat_puas, sd_puas, sd_kurang_puas, smp_sangat_puas, smp_puas, smp_kurang_puas, sma_sangat_puas, sma_puas, sma_kurang_puas, diploma_sangat_puas, diploma_puas, diploma_kurang_puas, sarjana_sangat_puas, sarjana_puas, sarjana_kurang_puas, total_responden) 
               VALUES ('$id_wilayah', '$lulusan_sangat_puas_sd', '$lulusan_puas_sd', '$lulusan_kurang_puas_sd', '$lulusan_sangat_puas_smp', '$lulusan_puas_smp', '$lulusan_kurang_puas_smp', '$lulusan_sangat_puas_sma', '$lulusan_puas_sma', '$lulusan_kurang_puas_sma', '$lulusan_sangat_puas_diploma', '$lulusan_puas_diploma', '$lulusan_kurang_puas_diploma', '$lulusan_sangat_puas_sarjana', '$lulusan_puas_sarjana', '$lulusan_kurang_puas_sarjana', '$total_responden_lulusan')";

    $query5 = "INSERT INTO profesi (id_wilayah, pns_sangat_puas, pns_puas, pns_kurang_puas, swasta_wiraswasta_sangat_puas, swasta_wiraswasta_puas, swasta_wiraswasta_kurang_puas, pelajar_mahasiswa_sangat_puas, pelajar_mahasiswa_puas, pelajar_mahasiswa_kurang_puas, pengangguran_sangat_puas, pengangguran_puas, pengangguran_kurang_puas, total_responden) 
               VALUES ('$id_wilayah', '$profesi_sangat_puas_pns', '$profesi_puas_pns', '$profesi_kurang_puas_pns', '$profesi_sangat_puas_swasta', '$profesi_puas_swasta', '$profesi_kurang_puas_swasta', '$profesi_sangat_puas_pelajar', '$profesi_puas_pelajar', '$profesi_kurang_puas_pelajar', '$profesi_sangat_puas_pengangguran', '$profesi_puas_pengangguran', '$profesi_kurang_puas_pengangguran', '$total_responden_profesi')";
